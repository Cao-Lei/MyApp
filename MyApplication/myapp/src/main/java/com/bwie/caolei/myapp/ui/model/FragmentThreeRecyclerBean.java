...
public class FragmentThreeRecyclerBean {
    ...
    /**
     * ctime : 2017-01-12
     * title : 每逢新年「过三关」！你准备好了吗？
     * description : 活法儿
     * picUrl : http://mmbiz.qpic.cn/mmbiz_png/fpcvIhMQKB89gIq9CAq5ly8ZlhFvugJffv9hj2mHdtV6Varicqxzo4ov2LuHDDibSbE0Kw3y3L5E7ZiaGBsGJfnWA/0?wx_fmt=png
     * url : http://mp.weixin.qq.com/s/NKa22zr46MNf6oMYF0-Dhw
     */
...
/*
    ...
    public FragmentThreeRecyclerBean(int imgid, String title, String content, String time) {
        this.imgid = imgid;
        this.title = title;
